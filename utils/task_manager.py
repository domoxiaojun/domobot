...
class TaskManager:
    ...
    def create_task(self, coro, name: Optional[str] = None, context: Optional[str] = None) -> Task:
        """创建并跟踪异步任务
...
# 便捷函数
def create_task(coro, name: Optional[str] = None, context: Optional[str] = None) -> Task:
    """创建任务的便捷函数"""
